...
namespace Ticari_Otamasyon.TicariOtomasyonDataSet1TableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[TBL_FIRMALAR] WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Original_YETKILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) OR ([YETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AND [YETKILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_SEKTOR = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TELEFON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_VERGIDAIRE = 1 AND [VERGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Original_VERGIDAIRE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [OZELKOD1] IS NULL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull_OZELKOD2 = 1 AND [OZELKOD2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND ((@IsNull_OZELKOD3 = 1 AND [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELKOD3)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_FIRMALAR] ([AD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [MAIL], [FAX], [IL], [ILCE], [VERGIDAIRE], [ADRES], [OZELKOD1], [OZELKOD2], [OZELKOD3]) VALUES (@AD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @MAIL, @FAX, @IL, @ILCE, @VERGIDAIRE, @ADRES, @OZELKOD1, @OZELKOD2, @OZELKOD3);
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETK" +
                ...
                "LEFON1] = @TELEFON1, [TELEFON2] = @TELEFON2, [MAIL] = @MAIL, [FAX] = @FAX, [IL] " +
                "= @IL, [ILCE] = @ILCE, [VERGIDAIRE] = @VERGIDAIRE, [ADRES] = @ADRES, [OZELKOD1] " +
                "= @OZELKOD1, [OZELKOD2] = @OZELKOD2, [OZELKOD3] = @OZELKOD3 WHERE (([ID] = @Orig" +
                "inal_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((" +
                "@IsNull_YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Origi" +
                "nal_YETKILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL" +
                ") OR ([YETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 " +
                "AND [YETKILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_S" +
                "EKTOR = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_" +
                "TELEFON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND (" +
                "(@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON" +
                "2)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND" +
                " ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@IsNull_" +
                "IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [I" +
                "LCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_VERGIDAIRE = 1 AND [VE" +
                "RGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Original_VERGIDAIRE)) AND ((@IsNull_ADRES" +
                " = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1" +
                " = 1 AND [OZELKOD1] IS NULL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull" +
                "_OZELKOD2 = 1 AND [OZELKOD2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND " +
                "((@IsNull_OZELKOD3 = 1 AND [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELKO" +
                "D3)));\r\nSELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1" +
                ", TELEFON2, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3" +
                " FROM TBL_FIRMALAR WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ticari_Otamasyon.Properties.Settings.Default.TicariOtomasyonConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON" +
                "2, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM dbo" +
                ".TBL_FIRMALAR";
        ...
        public virtual int Fill(TicariOtomasyonDataSet1.TBL_FIRMALARDataTable dataTable) {
        ...
        public virtual TicariOtomasyonDataSet1.TBL_FIRMALARDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TicariOtomasyonDataSet1.TBL_FIRMALARDataTable dataTable = new TicariOtomasyonDataSet1.TBL_FIRMALARDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TicariOtomasyonDataSet1.TBL_FIRMALARDataTable dataTable) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((short)(Original_ID));
            if ((Original_AD == null)) {
            ...
            if ((Original_YETKILISTATU == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_YETKILISTATU));
            }
            if ((Original_YETKILIADSOYAD == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_YETKILIADSOYAD));
            }
            if ((Original_YETKILITC == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((string)(Original_YETKILITC));
            }
            if ((Original_SEKTOR == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((string)(Original_SEKTOR));
            }
            if ((Original_TELEFON1 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[28].Value = ((string)(Original_TELEFON1));
            }
            if ((Original_TELEFON2 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[30].Value = ((string)(Original_TELEFON2));
            }
            if ((Original_MAIL == null)) {
            ...
            if ((Original_FAX == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((string)(Original_FAX));
            }
            if ((Original_IL == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[36].Value = ((string)(Original_IL));
            }
            if ((Original_ILCE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[38].Value = ((string)(Original_ILCE));
            }
            if ((Original_VERGIDAIRE == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[40].Value = ((string)(Original_VERGIDAIRE));
            }
            if ((Original_ADRES == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[49].Value = ((short)(ID));
        ...
        public virtual int Update(
                    ...
                    string Original_OZELKOD2, 
                    string Original_OZELKOD3) {
            return this.Update(AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3, Original_ID, Original_AD, Original_YETKILISTATU, Original_YETKILIADSOYAD, Original_YETKILITC, Original_SEKTOR, Original_TELEFON1, Original_TELEFON2, Original_MAIL, Original_FAX, Original_IL, Original_ILCE, Original_VERGIDAIRE, Original_ADRES, Original_OZELKOD1, Original_OZELKOD2, Original_OZELKOD3, Original_ID);
        }
    }
